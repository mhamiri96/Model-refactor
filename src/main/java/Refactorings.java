...
public class Refactorings {
    ...
    public static int executeRefactoring(int num) {
        if (num == 0) {
            System.out.println("set add Generalisation");
            return addGeneralisation();
        }
        if (num == 1) {
            System.out.println("deleteGeneralisation");
        ...
        if (num == 4) {
            System.out.println("moveAttribute");
        ...
        if (num == 7) {
            System.out.println("extractClass");
            return extractClass();
        }
        if (num == 8) {
        ...
        if (num == 10) {
            System.out.println("pushDownAttribute");
    ...
    public static int addGeneralisation() {
        ...
        if (print_executed_refactorings) 
            System.out.println("add Generalisation from " + className + " to " + superClass + " executed");
        Ref = new String[3];
    ...
    public static int deleteGeneralisation() {
        ...
        while (!Info.hasSuperClass(className)) {
            ...
            i++;
            if (i == 199) {
                System.out.println("Finding superClass failed! aborting");
                return 0;
            }
        }
        ...
        if (print_executed_refactorings)
            System.out.println("delete Generalisation: " + className + " " + superClass + " executed");
        Ref = new String[3];
    ...
    public static int addRelationShip() {
        ...
        while (!Info.hasMethod(class1) && ok) {
            ...
            i++;
            if (i == 200) {
                System.out.println("Finding Class with method failed! aborting");
                return 0;
            }
        }
        i = 0;
        ...
        if (print_executed_refactorings)
            System.out.println("add Relationship: between" + class1 + " " + line + " " + class2 + " executed");
        Ref = new String[3];
    ...
    public static int deleteRelationShip() {
        ...
        if (print_executed_refactorings) 
            System.out.println("delete Relationship: " + class1 + " " + line + " executed");
        Ref = new String[3];
    ...
    public static int moveParameter() {
        ...
        while (!Info.hasParameter(class1, Info.getNameMethod(method1))) {
            ...
            i++;
            if (i == 200) {
                System.out.println("Finding Parameter in method failed! aborting");
                return 0;
            }
        }
        String method2 = Random.randomMethod(class2);
        ...
        if (print_executed_refactorings)
            System.out.println("move from Class " + class1 + " the Parameter " + parameter + " to the Class " + class2 + " executed");
        Ref = new String[4];
        Ref[0] = "moveParameter()";
        Ref[1] = class1;
        Ref[2] = parameter;
    ...
    public static int moveMethod() {
        ...
        if (print_executed_refactorings)
            System.out.println("move from Class " + class1 + " the Method " + method + " to the Class " + class2 + " executed");
        Ref = new String[4];
        Ref[0] = "moveMethod()";
        Ref[1] = class1;
        Ref[2] = method;
    ...
    public static int moveAttribute() {
        ...
        while (!Info.hasAttribute(class1)) {
            ...
            i++;
            if (i == 200) {
                System.out.println("Finding Class with attribute failed! aborting");
                return 0;
            }
        }
        ...
        if (print_executed_refactorings)
            System.out.println("Move from Class " + class1 + " Attribute " + attribute + " to Class " + class2 + " executed");
        Ref = new String[4];
        Ref[0] = "moveAttribute()";
        Ref[1] = class1;
        Ref[2] = attribute;
    ...
    public static int extractClass() {
        ...
        if (print_executed_refactorings)
            System.out.println("extract Class: " + className + " " + " new " + className + " executed ");
        Ref = new String[2];
        Ref[0] = "extractClass()";
        Ref[1] = className;
        return effort;
    ...
    public static int pullUpAttribute() {
        ...
        while ((!Info.hasSuperClass(class1) || !Info.hasAttribute(class1)) && ok) {
            ...
            i++;
            if (i == 200) {
                System.out.println("Finding Class with super-Class and attribute failed! aborting");
                return 0;
            }
        }
        if (ok == false)
        ...
        if (print_executed_refactorings)
            System.out.println("PullUp Attribute " + attribute + " from class " + class1 + " to super-Class " + class2 + " executed");
        Ref = new String[4];
    ...
    public static int pullUpMethod() {
        ...
        while ((!Info.hasSuperClass(class1) || !Info.hasMethod(class1)) && ok) {
            ...
            i++;
            if (i == 200) {
                System.out.println("Finding Class with super-Class and method failed! aborting");
                return 0;
            }
        }
        if (ok == false)
        ...
        if (print_executed_refactorings)
            System.out.println("PullUp method " + method + " from class " + class1 + " to super-Class " + class2 + " executed");
        Ref = new String[4];
        Ref[0] = "pullUpMethod()";
        Ref[1] = class1;
        Ref[2] = method;
    ...
    public static int pushDownAttribute() {
        ...
        while (!Info.hasSubClass(class1) || !Info.hasAttribute(class1)) {
            ...
            i++;
            if (i == 200) {
                System.out.println("Finding Class with sub-Class and attribute failed! aborting");
                return 0;
            }
        }
        ...
        if (print_executed_refactorings)
            System.out.println("PushDown Attribute " + attribute + " from class " + class1 + " to super-Class " + class2 + " executed");
        Ref = new String[4];
    ...
    public static int pushDownMethod() {
        ...
        while (!Info.hasSubClass(class1) || !Info.hasMethod(class1)) {
            ...
            i++;
            if (i == 200) {
                System.out.println("Finding Class with sub-Class and method failed! aborting");
                return 0;
            }
        }
        String class2 = Random.randomSubClass(class1);
        ...
        if (print_executed_refactorings) 
            System.out.println("Pushdown method " + method + " from class " + class1 + " to super-Class " + class2 + " executed");
        Ref = new String[4];
